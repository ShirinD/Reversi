...
socket.on('game_update', function(payload){
	...
	/* --shirin --*/
	if ( my_color == 'white') {
	var player_name = 'THOR';
	}
	else {
	var player_name = 'HULK';
	}
	
	if ( payload.game.whose_turn == 'white') {
	var player_turn = 'Thor';
	}
	else {
	var player_turn = 'Hulk';
	}
	/*--- shirin end ---*/	
		...
		for (column=0; column<8; column++){
			...
			if (old_board[row][column] !== board[row][column]){
				...
				if (old_board[row][column] === '?' && board[row][column] === ' ') {
					...
					$('#'+row+'_'+column).html('<img src="assets/images/empty_to_thor.gif" alt="white square">');
				}
				else if (old_board[row][column] === '?' && board[row][column] === 'b'){
					$('#'+row+'_'+column).html('<img src="assets/images/empty_to_hulk.gif" alt="black square">');
				}
				else if (old_board[row][column] === ' ' && board[row][column] === 'w') {
					$('#'+row+'_'+column).html('<img src="assets/images/empty_to_thor.gif" alt="empty square">');
				}
				else if (old_board[row][column] === ' ' && board[row][column] === 'b'){
					$('#'+row+'_'+column).html('<img src="assets/images/empty_to_hulk.gif" alt="empty square">');
				}
				else if (old_board[row][column] === 'w' && board[row][column] === ' ') {
					$('#'+row+'_'+column).html('<img src="assets/images/thor_to_hulk.gif" alt="black square">');
				}
				else if (old_board[row][column] === 'b' && board[row][column] === ' '){
					$('#'+row+'_'+column).html('<img src="assets/images/hulk_to_thor.gif" alt="white square">');
				}
